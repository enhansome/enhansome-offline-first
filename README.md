# Awesome Offline-First with stars
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,128 | 🐛 107 | 📅 2026-09-02 list thing.
...
[Almost any web page can work offline](https://github.com/homam/service-workers-example) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2016-12-27
...
[Service Worker Recipes](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker) ⭐ 5,884 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-18
...
[offline-plugin](https://github.com/NekR/offline-plugin/) ⭐ 4,507 | 🐛 110 | 🌐 JavaScript | 📅 2021-11-08: Offline plugin (ServiceWorker, AppCache) for webpack.
...
[bottle-service](https://github.com/bahmutov/bottle-service) ⭐ 333 | 🐛 7 | 🌐 JavaScript | 📅 2016-01-29: Instant web applications restored from ServiceWorker cache.

[react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,474 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23: Quick setup for performance orientated, offline-first React.js applications.
...
[sw-toolbox](https://github.com/GoogleChrome/sw-toolbox) ⚠️ Archived: A collection of tools for service workers.
...
[MakeDrive](https://github.com/mozilla/makedrive) ⚠️ Archived: A cloud-based Dropbox® equivalent for browser filesystems. Designed for use with Mozilla Webmaker tools and services.
...
[appCache Nanny](https://github.com/gr2m/appcache-nanny) ⚠️ Archived:  JavaScript APIs for appCache

[bro-fs](https://github.com/vitalets/bro-fs) ⭐ 46 | 🐛 3 | 🌐 JavaScript | 📅 2020-07-16: Promise-based wrapper over [HTML5 Filesystem API](https://www.w3.org/TR/file-system-api/) allowing to work with sandboxed filesystem in Chrome.

[Orbit.js](http://orbitjs.com/): Framework for orchestrating access, transformation, and synchronization between data sources.

[workbox](https://github.com/GoogleChrome/workbox) ⭐ 13,022 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-02: JavaScript libraries for Offline Caching

[rxdb](https://github.com/pubkey/rxdb) ⭐ 23,391 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25
...
Thanks to all [contributors](https://github.com/pazguille/offline-first/graphs/contributors) ⭐ 3,322 | 🐛 8 | 📅 2022-11-23.
