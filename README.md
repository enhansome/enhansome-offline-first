...
[Service Worker Recipes](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker) ⭐ 5,889 | 🐛 126 | 🌐 JavaScript | 📅 2026-08-12
...
[react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,490 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23: Quick setup for performance orientated, offline-first React.js applications.
...
[localForage](https://github.com/localForage/localForage) ⭐ 25,798 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30: Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
...
[workbox](https://github.com/GoogleChrome/workbox) ⭐ 12,976 | 🐛 100 | 🌐 JavaScript | 📅 2026-08-04: JavaScript libraries for Offline Caching

[rxdb](https://github.com/pubkey/rxdb) ⭐ 23,335 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-13
...
Thanks to all [contributors](https://github.com/pazguille/offline-first/graphs/contributors) ⭐ 3,315 | 🐛 7 | 📅 2022-11-23.
