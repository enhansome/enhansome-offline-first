...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,594 | 🐛 106 | 📅 2026-09-02 list thing.
...
[Service Worker Recipes](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker) ⭐ 5,885 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-18
...
[react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,475 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23: Quick setup for performance orientated, offline-first React.js applications.
...
[workbox](https://github.com/GoogleChrome/workbox) ⭐ 13,023 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-02: JavaScript libraries for Offline Caching

[rxdb](https://github.com/pubkey/rxdb) ⭐ 23,390 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-24
...
Thanks to all [contributors](https://github.com/pazguille/offline-first/graphs/contributors) ⭐ 3,323 | 🐛 8 | 📅 2022-11-23.
