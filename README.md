...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,309 | 🐛 105 | 📅 2026-08-18 list thing.
...
[Service Worker Recipes](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker) ⭐ 5,887 | 🐛 126 | 🌐 JavaScript | 📅 2026-08-18
...
[react-boilerplate](https://github.com/mxstbr/react-boilerplate) ⭐ 29,492 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23: Quick setup for performance orientated, offline-first React.js applications.
...
[workbox](https://github.com/GoogleChrome/workbox) ⭐ 12,983 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-04: JavaScript libraries for Offline Caching

[rxdb](https://github.com/pubkey/rxdb) ⭐ 23,355 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-21
...
Thanks to all [contributors](https://github.com/pazguille/offline-first/graphs/contributors) ⭐ 3,318 | 🐛 7 | 📅 2022-11-23.
